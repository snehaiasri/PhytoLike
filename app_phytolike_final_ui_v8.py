...
from rdkit.Chem import AllChem, Crippen, Descriptors, Lipinski, rdMolDescriptors, Draw
    ...
    with single_pred_tab:
        ...
        with right:
            ...
            if canonical_preview:
                mol_img = draw_molecule(canonical_preview)
                if mol_img is not None:
                    st.image(mol_img, caption="2D structure preview")
            else:
                st.info("A valid SMILES string will show a structure preview here.")
